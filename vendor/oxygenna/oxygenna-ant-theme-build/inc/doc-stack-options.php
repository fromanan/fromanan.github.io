...
define('OXY_STACKS_DIR', $theme_root . '/vendor/oxygenna/oxygenna-stacks/');
...
$stack_options = include $options_file;

ob_start();?>
---
  title: Skin Options
  subtitle: A list of all options available to modify the theme skin
  layout: docs.hbs
  section: options
---
<?php foreach ($stack_options as $section) : ?>

...
class OxygennaMediaUpload
{
    ...
    public function image_attachments($form_fields, $post)
    {
        ...
        $send = '<input type="submit" onclick="oxyThemeOptions.mediaOptionSelectImage(\'' . $_REQUEST['input_id'] . '\',\'' . $post->guid . '\',\'' . $post->ID . '\')" class="button" value="' .__('Select Image', 'omega-admin-td') . '">';
